...
var file_frame_frame_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x1b, 0x0a, 0x05, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61,
	0x22, 0x1f, 0x0a, 0x03, 0x41, 0x63, 0x6b, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x32, 0x30, 0x0a, 0x0c, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x20, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x46, 0x72, 0x61, 0x6d, 0x65,
	0x73, 0x12, 0x06, 0x2e, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x1a, 0x04, 0x2e, 0x41, 0x63, 0x6b, 0x28,
...
var file_frame_frame_proto_depIdxs = []int32{
	0, // 0: FrameService.StreamFrames:input_type -> Frame
	1, // 1: FrameService.StreamFrames:output_type -> Ack
...
func file_frame_frame_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_frame_frame_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Frame); i {
			case 0:
				return &v.state
			case 1:
		...
		file_frame_frame_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Ack); i {
			case 0:
				return &v.state
			case 1:
